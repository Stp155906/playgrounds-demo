...
public extension Image {
    ...
    struct DesignSystem {
        public static let waveform = loadImageFromBundle(name: "waveform")
        public static let background = loadImageFromBundle(name: "background")
        public static let avatar1 = loadImageFromBundle(name: "avatar1")
        public static let avatar2 = loadImageFromBundle(name: "avatar2")
        public static let avatar3 = loadImageFromBundle(name: "avatar3")
